...
const config = {
  ...
  projectName: 'Physical_AI_-_Humanoid_Robotics', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/Areejshaikh/Physical_AI_-_Humanoid_Robotics/tree/master/',
        },
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        logo: {
          alt: 'Robot Logo',
          src: 'img/robot-logo.jpeg', // Using existing logo
        },
        items: [
          {
            type: 'docSidebar',
          ...
          {
            href: 'https://github.com/Areejshaikh/Physical_AI_-_Humanoid_Robotics',
            label: 'GitHub',
            position: 'right',
          },
        ],
